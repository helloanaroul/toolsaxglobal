...
export default function ToolActions({ tool }: ToolActionsProps) {
  ...
  const embedCode = `<iframe src="https://toolsax.vercel.app/embed/${tool.id}?theme=${theme}" width="100%" height="600" style="border:none;overflow:hidden;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>`;
          ...
          <ResponsiveModalContent>
              <ResponsiveModalHeader>
                  ...
                  <ResponsiveModalDescription>
                      Copy and paste this code into your website to embed this tool.
                  </ResponsiveModalDescription>
              </ResponsiveModalHeader>
              <div className="py-4">
